<template>
  <article class="content-type1">
    ...
    <div>
      <h2><i class="far fa-square"></i> Article 1: Contrat de vente</h2>
      <ol>
        <li>
    ...
    <div>
      <h2><i class="far fa-square"></i> Article 2: Types de prestations</h2>
      <ol>
        <li>
    ...
    <div>
      <h2><i class="far fa-square"></i> Article 3: Cahier des charges</h2>
      <ol>
        <li>
    ...
    <div>
      <h2><i class="far fa-square"></i> Article 4: Tarifs et prestations</h2>
      <ol>
        <li>
    ...
    <div>
      <h2><i class="far fa-square"></i> Article 5: Délai de paiement</h2>
      <ol>
        <li>
    ...
    <div>
      <h2><i class="far fa-square"></i> Article 6: Délai de livraison</h2>
      <ol>
        <li>
    ...
    <div>
      <h2><i class="far fa-square"></i> Article 7: Modification de commande</h2>
      <ol>
        <li>
    ...
    <div>
      <h2><i class="far fa-square"></i> Article 8: Propriété intellectuelle</h2>
      <ol>
        <li>
    ...
    <div>
      <h2><i class="far fa-square"></i> Article 9: Cessions de droits</h2>
      <ol>
        <li>
    ...
    <div>
      <h2><i class="far fa-square"></i> Article 10: Mentions commerciales et droit de publicité</h2>
      <ol>
        <li>
    ...
    <div>
      <h2><i class="far fa-square"></i> Article 11: Litiges</h2>
      <ol>
        <li>
        ...
        <li>
          ...
          soumis au droit français. À défaut de conciliation amiable, le litige pourra être porté devant un
          tribunal compétent.
        </li>
      </ol>
    </div>
